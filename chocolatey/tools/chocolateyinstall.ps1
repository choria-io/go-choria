...
$fileLocation = Join-Path $toolsDir 'Choria-0.24.1.msi'
...
$url=''
$url64      = 'https://github.com/choria-io/go-choria/releases/download/v0.24.1/Choria-0.24.1.msi' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
...
$packageArgs = @{
  ...
  softwareName  = 'choria*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
  ...
  checksum64    = 'F0E95A9E578B4009939B23E271678D32A53D0914D529F93D0B4AFB9726D16524'
