...
//
//	mockgen -write_generate_directive -package network -destination mock_server_client_authentication_test.go github.com/nats-io/nats-server/v2/server ClientAuthentication
//
...
//go:generate mockgen -write_generate_directive -package network -destination mock_server_client_authentication_test.go github.com/nats-io/nats-server/v2/server ClientAuthentication
...
func (m *MockClientAuthentication) GetID() uint64 {
	m.ctrl.T.Helper()
...
func (mr *MockClientAuthenticationMockRecorder) GetID() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetID", reflect.TypeOf((*MockClientAuthentication)(nil).GetID))
}
