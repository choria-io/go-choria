...
type ChoriaPluginConfig struct {
	...
	ServerTokenFile              string   `confkey:"plugin.choria.security.server.token_file" type:"path_string"`                                                   // The server token file to use for authentication, defaults to choria.token in the same location as server.conf
	ServerTokenSeedFile          string   `confkey:"plugin.choria.security.server.seed_file" type:"path_string"`                                                    // The server token seed to use for authentication, defaults to choria.key in the same location as server.conf
