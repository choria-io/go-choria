...
type ChoriaPluginConfig struct {
	...
	NetworkAuthTimeout                 int           `confkey:"plugin.choria.network.auth_timeout" default:"2"`                                                    // Time to allow for clients to authenticate, increase on slow or very large networks
