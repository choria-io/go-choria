...
// Source: vendor/github.com/choria-io/go-choria/choria/connection.go
...
func (m *MockConnectionManager) NewConnector(ctx context.Context, servers func() ([]srvcache.Server, error), name string, logger *logrus.Entry) (choria.Connector, error) {
...
// ReplyTarget mocks base method
func (m *MockConnector) ReplyTarget(msg *choria.Message) string {
	ret := m.ctrl.Call(m, "ReplyTarget", msg)
	ret0, _ := ret[0].(string)
	return ret0
}
