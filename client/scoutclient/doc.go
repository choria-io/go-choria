...
//
// Client for Choria RPC Agent 'scout' Version 0.26.2 generated using Choria version 0.26.2

// Package scoutclient is an API client to the Choria Scout agent Version 0.26.2.
//
// Actions:
