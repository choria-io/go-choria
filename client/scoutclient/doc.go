...
//
// Client for Choria RPC Agent 'scout' Version 0.23.0 generated using Choria version 0.23.0

// Package scoutclient is an API client to the Choria Scout agent Version 0.23.0.
//
// Actions:
