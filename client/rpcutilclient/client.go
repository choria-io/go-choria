...
func Must(fw ChoriaFramework, opts ...InitializationOption) (client *RpcutilClient) {
	c, err := New(fw, opts...)
	if err != nil {
		panic(err)
	}
...
func New(fw ChoriaFramework, opts ...InitializationOption) (client *RpcutilClient, err error) {
	c := &RpcutilClient{
		fw:            fw,
		ddl:           &agent.DDL{},
		clientRPCOpts: []rpcclient.RequestOption{},
