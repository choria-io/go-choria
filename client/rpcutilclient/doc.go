...
//
// Client for Choria RPC Agent 'rpcutil' Version 0.26.0 generated using Choria version 0.26.0

// Package rpcutilclient is an API client to the Choria Rpcutil agent Version 0.26.0.
//
// Actions:
