...
//
// Client for Choria RPC Agent 'choria_provision' Version 0.22.0 generated using Choria version 0.22.0
...
func (d *ReleaseUpdateOutput) HashMap() map[string]interface{} {
	return d.reply
}
...
func (d *ReleaseUpdateRequester) Do(ctx context.Context) (*ReleaseUpdateResult, error) {
	dres := &ReleaseUpdateResult{ddl: d.r.client.ddl}
...
func (d *ReleaseUpdateOutput) Message() interface{} {
