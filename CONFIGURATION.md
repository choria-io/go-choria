...
|[plugin.nats.user](#pluginnatsuser)|[plugin.scout.goss.file](#pluginscoutgossfile)|
...
## plugin.scout.goss.file

 * **Type:** path_string

Path to the file holding the gossfile for the goss builtin
