...
//go:generate mockgen -write_generate_directive -package message -destination protocol_mock_test.go -source ../protocol/protocol.go
...
func (m *MockRequest) Version() protocol.ProtocolVersion {
	m.ctrl.T.Helper()
...
// Version mocks base method.
func (m *MockReply) Version() protocol.ProtocolVersion {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Version")
	ret0, _ := ret[0].(protocol.ProtocolVersion)
	return ret0
...
func (mr *MockSecureRequestMockRecorder) SetSigner(signer any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Version mocks base method.
func (m *MockSecureRequest) Version() protocol.ProtocolVersion {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Version")
	ret0, _ := ret[0].(protocol.ProtocolVersion)
	return ret0
...
// Version mocks base method.
func (m *MockSecureReply) Version() protocol.ProtocolVersion {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Version")
	ret0, _ := ret[0].(protocol.ProtocolVersion)
	return ret0
...
// Version mocks base method.
func (m *MockTransportMessage) Version() protocol.ProtocolVersion {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Version")
	ret0, _ := ret[0].(protocol.ProtocolVersion)
	return ret0
