...
//  mockgen -package provtarget -destination target_resolver_mock_test.go -source provtarget.go
...
func (mr *MockTargetResolverMockRecorder) Configure(arg0, arg1, arg2 interface{}) *gomock.Call {
