...
//go:generate mockgen -write_generate_directive -package mcorpc -destination server_info_source_mock_test.go github.com/choria-io/go-choria/server/agents ServerInfoSource
