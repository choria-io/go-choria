...
func NewResumeCommand(ids []string, classes []string, facts []string, combined []string, checks []string, json bool, cfile string, verbose bool, colorize bool, log *logrus.Entry) (*ResumeCommand, error) {
