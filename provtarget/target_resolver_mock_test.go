...
func (m *MockTargetResolver) Targets() []string {
...
func (mr *MockTargetResolverMockRecorder) Targets() *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Targets", reflect.TypeOf((*MockTargetResolver)(nil).Targets))
}
