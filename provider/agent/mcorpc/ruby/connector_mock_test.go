...
// Source: ../../../go-choria/choria/connection.go
...
func (m *MockConnectionManager) NewConnector(ctx context.Context, servers func() (go_srvcache.Servers, error), name string, logger *logrus.Entry) (choria.Connector, error) {
