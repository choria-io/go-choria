...
// Source: ../vendor/github.com/choria-io/go-protocol/protocol/protocol.go
...
func (m *MockRequest) NewFilter() *protocol.Filter {
...
func (m *MockRequest) SetFilter(arg0 *protocol.Filter) {
...
func (m *MockRequest) Filter() (*protocol.Filter, bool) {
...
// SetMessage mocks base method
func (m *MockSecureRequest) SetMessage(request protocol.Request) error {
...
// SetMessage mocks base method
func (m *MockSecureReply) SetMessage(reply protocol.Reply) error {
...
func (m *MockTransportMessage) SetReplyData(reply protocol.SecureReply) error {
...
func (m *MockTransportMessage) SetRequestData(request protocol.SecureRequest) error {
